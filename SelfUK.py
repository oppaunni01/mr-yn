...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token="EqFl8qC7wNI03weYqRb8.1TO2iVTaiu7TRP5snDEZwa.MPEDHEjVz2q/biYCxfG3ng033ycUCF+jY9CqTo3K9p0=")
cl.loginResult()
...
Bots=["ud6da3622fb40214eedae9e5235d7b358"]
admin=["ud6da3622fb40214eedae9e5235d7b358"]
wait = {
    "likeOn":True,
    "alwayRead":False,
    "detectMention":True,    
...
#==============================================================================#
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': "ud6da3622fb40214eedae9e5235d7b358"}
                cl.sendMessage(msg)
