...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token="EpoEWubDxSQvdu5QweL9.3UrGMEjECFh9gbFk6EFekq.Tq8TnmcG3/7obSpM86biDDVMwKhnps2mR+sLwSXcxHE=")
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token="EpbULH3D5Xh1F5FpNBde.F6loN/ws9FaPqFRwqoggJG.3Fe7pUjl2xCPRgW/Ovbzt05iKK+W7U8o+uC2zBrvX+w=")
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token="EpIoJsI9AIkHRcy3acy3.9qPM7NC2vWiRtQTZ/x4SyW./QNI7WAPs17/BQs4Tw/g19b8iGSMRqzzeuB0Wu9acso=")
kk.loginResult()
print "Kk-Login Success\n"

kc = LINETCR.LINE()
#kc.login(qr=True)
kc.login(token="EpeUALSVrEcZMOcVZP8e.9lU+Lm8IEAdBW1wrKZGG7G.EXlG78sHLlzYua0HwUqIyZBaO5i4va3p7FpCrYWNuCs=")
kc.loginResult()
print "Kc-Login Success\n"

kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token="EpSdZe8Vn38pO5x9Hi2a.4873flXX7QJRw4jo2j7roG.2vPJtVtHYOqGw0A/9l0xDxHRCA4UbWqYv0EJ7U9EXOw=")
kr.loginResult()
print "Kr-Login Success\n"

km = LINETCR.LINE()
#km.login(qr=True)
km.login(token="EpZZlM5yPyA6D81Qyie8.MQvnSQmxLZyecm+cYLEska.f0YPP5BgqwWI5wVNAZIw4VjYs0hEwjulvc0ltNHvubo=")
km.loginResult()
...
Creator=["udee46099e25e71f1fd1817cae9e7c429"]
admin=["udee46099e25e71f1fd1817cae9e7c429","u9aa54db2a31797360408cfc2ca579228","u7fa2ce9fe592f5f02941fad640e1868e","uf50a66ee773657022b4eab73f97e2c63","uf4bbbf94cf2279a0dbc35591933820ee","ue3cef714bc71eea8eb5b824ed89ed13a",]
...
wait = {
    ...
    "commentOn":True,
    "commentBlack":{},
    "message":"nah kan kaannnn ketahuan add kan",    
    "blacklist":{},
    "wblacklist":False,
    "dblacklist":False,
    "Qr":{},
...
def bot(op):
    try:
	    ...
	    if mid in op.param3:	        
			...
			cl.updateGroup(G)
			cl.sendText(op.param1,"Ketik help buat bantuan \nOjo songon ni cuma dumay boss")
	    ...
	    if mid in op.param3:
			...
			G.preventJoinByTicket = True
			cl.updateGroup(G)
			l.sendText(op.param1,"Ketik help buat bantuan \nOjo songon ni cuma dumay boss")
	    else:
...
#		    cl.sendText(msg.to,"Khusus Nadya")
		...
		if wait["Simi"] == True: md+="❈➩✔️ Simisimi : On\n"
            ...
            elif msg.text in ["Jilatin","Jem bot"]:
		...
		if msg.from_ in Creator:
		    ...
		    cl.sendText(msg.to,"Lu sape!")
              ...
              if msg.from_ in admin:
                ...
                cl.sendText(msg.to,"Ketik Help Bantuan") 
		...
		if msg.from_ in Creator:
	        ...
	        if msg.from_ in Creator:                
              ...
              if msg.from_ in Creator:
                msg.contentType = 13
                msg.contentMetadata = {'mid': "U.K MORA,'"}
                cl.sendMessage(msg)

 
            elif "Uk copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("Uk copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = cl.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
            ...
            elif msg.text.lower() in ["pap owner","pap mora"]:
            ...
            elif msg.text.lower() in ["kiss","Kiss"]:
                                link = ["http://www.animatedimages.org/data/media/383/animated-kiss-image-0023.gif"]
                                pilih = random.choice(link)
                                cl.sendImageWithURL(msg.to,pilih)
		...
		if msg.from_ in Creator:
                    string = msg.text.replace(".cnkapten","Uk Kapten")
		...
		if msg.from_ in Creator:
                    string = msg.text.replace(".cntc1","Uk TC1")
                    if len(string.decode('utf-8')) <= 5000:
		...
		if msg.from_ in Creator:
                    string = msg.text.replace(".cntc2","Uk TC2")
                    if len(string.decode('utf-8')) <= 5000:
		...
		if msg.from_ in Creator:
                    string = msg.text.replace(".cntc3","Uk TC3")
                    if len(string.decode('utf-8')) <= 5000:
		...
		if msg.from_ in Creator:
                    string = msg.text.replace(".cntc4","Uk TC4")
                    if len(string.decode('utf-8')) <= 5000:
                        profile = cl.getProfile()
                        profile.displayName = string
                        kr.updateProfile(profile)
            ...
            elif "Baperin " in msg.text:
              if msg.from_ in Creator:
                ulti0 = msg.text.replace("Baperin ","")
                ulti1 = ulti0.rstrip()
                ulti2 = ulti1.replace("@","")
                ulti3 = ulti2.rstrip()
                _name = ulti3
                ...
                result = page[page.find(cari_hasil)+len(cari_hasil):]
                result = result.split("<")[0]
                cl.sendText(msg.to,"----Dari Arabia----\n" + "" + kata + "\n\n----Ke Indonesia----\n" + "" + result)
