...
nadya = MORA.LINE()
#nadya.login(qr=True)
nadya.login(token='Eq1GiChNbs5RshI0qZX5.FB71M2QkkIwofQXkk9ovDq.Im+gMcp9oZD0n9ErtV+GZBZBww9vFTx6L0ECLsQxLfc=')
nadya.loginResult()
print "BOJOKU-Login Success\n\n=====[Sukses Login]====="
...
╠═════════════════
  http://line.me/ti/p/Tq1A2KSg0K
"""
tjia="u7dbef59b6a8a2a258e16ac4a2bd39575"
...
Bots=[mid]
Creator=["u7dbef59b6a8a2a258e16ac4a2bd39575"]
