...
#			cl.sendText(op.param1,"☆Ketik ☞Help☜ Untuk Bantuan☆\n☆Harap Gunakan Dengan Bijak ^_^ ☆")
	    ...
	    cl.sendImageWithURL(op.param1,image)
            balas = ["Hallo Kakak " + cl.getContact(op.param2).displayName + "Selamat Bergabung Di Group  " + str(ginfo.name) + "Salam Kenal kakak Dan Salam Hormat Salam Silatur Rahmi Saja Kakak"]
	    ret_ = random.choice(balas)
            lang = 'id'
            tts = gTTS(text=ret_, lang=lang)
            tts.save("hasil.mp3")
